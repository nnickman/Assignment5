...
namespace Assignment_5.Controllers
{
    public class SongsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Price,ArtistID")] Song song)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Price,ArtistID")] Song song)
        {
            if (id != song.Id)
            {
                return NotFound();
